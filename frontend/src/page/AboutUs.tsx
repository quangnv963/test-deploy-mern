...
const AboutUs = () => {
  ...
  return (
    <div>
        <Header/>
        <Slider/>
        <div className='xl:mx-[300px] mx-[20px] md:mx-[42px] lg:mx-[120px] py-10'>
          <div className=''>
            <p className='font-sans text-[#1a90c9] font-medium xl:text-[42px] text-[20px] md:text-[25px] lg:text-[33px]'>Overview of OPM Technology Group</p>
          </div>
          <div className='w-full h-[150px] md:h-[270px] lg:h-[400px] xl:h-[600px] mt-[20px] xl:mt-[50px]'>
            <div
          ...
          <div className='py-8 text-[18px] md:text-[21px] lg:text-[24px] xl:text-[26px] text-[#4A4A4A] font-sans]'>
